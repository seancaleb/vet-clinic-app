<aside class="fixed top-0 bottom-0 left-0 bg-white border-r border-gray-300 min-w-[256px]">
    <div class="p-6">
        {{-- Navigation logo  --}}
        <x-application-logo class="h-[36px] mb-6" />
        ...
        <div class="grid gap-6">
            ...
            <div class="grid gap-2">
                ...
                <ul class="grid gap-1">
                    <li><x-ui.nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')"><svg viewBox="0 0 20 20"
                                class="w-6 h-6 fill-gray-600" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <li><x-ui.nav-link :href="route('appointments.index')" :active="request()->routeIs('appointments.index')"><svg class="w-6 h-6 text-gray-600"
                    ...
                    @if (Auth::user()->role === 'admin')
                        <li><x-ui.nav-link :href="route('users.index')" :active="request()->routeIs('users.index')"><svg class="w-6 h-6 text-gray-600"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    fill="currentColor" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd"
            ...
            <div class="grid gap-2">
                ...
                <ul class="grid gap-1">
                    <li><x-ui.nav-link :href="route('profile.edit')" :active="request()->routeIs('profile.edit')"><svg class="w-6 h-6 text-gray-600"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd"
                    ...
                    <li class="flex items-center gap-3 text-gray-500 font-medium text-[0.9375rem] px-4 py-2 rounded-lg">
